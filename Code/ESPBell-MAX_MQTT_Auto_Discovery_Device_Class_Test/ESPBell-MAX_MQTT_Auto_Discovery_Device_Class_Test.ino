...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(),mqtt_username, mqtt_password)) {
        ...
        // Send auto-discovery message for doorbell, //device_class - running
        client.publish(
          "homeassistant/binary_sensor/espbell-max/state/config", 
          "{\"name\":\"Bell\",\"unit_of_measurement\":\"\",\"device_class\":\"running\",\"icon\":\"mdi:bell\",\"state_topic\":\"homeassistant/binary_sensor/espbell-max/state\",\"unique_id\":\"espbell-max_bell\",\"payload_on\":\"on\",\"payload_off\":\"off\",\"device\":{\"identifiers\":[\"espbell-max\"],\"name\":\"ESPBell-MAX\",\"mdl\":\"ESPBell-MAX\",\"mf\":\"PricelessToolkit\"}}",
          retain
        );
