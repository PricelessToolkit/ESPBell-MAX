...
> [!WARNING]
> If there is current leakage between contacts 1 and 2 see "Dorbell wiring diagram" ESPBell-Max may trigger randomly "The current flow may be due to the installed light bulb in the doorbell button" So before you start it’s better to check it with a multimeter.
